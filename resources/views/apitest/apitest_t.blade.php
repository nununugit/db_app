...
<body>
    <p>Request Url
        <input type="text" value="/api/teachers" id="baseurl" size="50">
    </p>
    <table border="1">
        <tr>
            <th>HTTPメソッド</th>
    ...
    <hr> 【２】
    <p>
        教師氏名 <input type="text" value="" id="t_name2" size="20">
        <br> 
        教師の説明 <textarea id="t_content2" rows="4" cols="40"></textarea>
    </p>
    <p>
    ...
    <p>id 
        ...
        タイトル <input type="text" value="" id="t_name4" size="20"><br>
        本文 <textarea id="t_content4" rows="4" cols="40"></textarea>
    </p>
